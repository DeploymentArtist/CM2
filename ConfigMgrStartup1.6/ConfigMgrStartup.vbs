...
' 1.60:		Added ability to specify ccmsetup parameters (lie source and BITSPriority) 
...
Sub Main
	...
	If OpenConfig (argsNamed, xmlConfig) Then
		...
		LoadOptions xmlConfig, configOptions, "Option", MSG_LOADOPTIONS_OPTIONLOADED
		LoadOptions xmlConfig, msiProperties, "InstallProperty", MSG_LOADOPTIONS_PROPERTYLOADED
		LoadOptions xmlConfig, ccmsetupParams, "CCMSetupParameter", MSG_LOADOPTIONS_PARAMLOADED
...
Sub LoadOptions(ByRef config, ByRef values, ByVal nodeName, ByVal msg)
